...
public class FastFoodAdapter extends ArrayAdapter<FastfoodClass> {
    ...
    int quantity = 0, quantity1 = 0, quantity2 = 0, quantity3 = 0;
    int i = 0;
    int value = 0; int hold = 0;
    int pos = 0, counter = 1;
                ...
                if(quantity != 0) { //if quan < 0 or equals to 0
                    if (pos == 0) {
                        ...
                        if (isinserted)
                        {
                            ...
                            order_details[i] = "Id " + counter + " Beef Burger Price NT " + 250 * quantity + " ";
                    ...
                    if (pos == 1) {
                        ...
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Chicken Burger Price NT " + 220 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    if (pos == 2) {
                        ...
                        {
                            int price = 1;
                            order_details[i] = "Id : " + counter + " Zinger Burger Price NT " + 350 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    /*if (pos == 3) {
                        ...
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Fries Price NT " + 120 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    /*if (pos == 4) {
                        ...
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Zinger Roll Price NT " + 200 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    /*if (pos == 5) {
                        ...
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Club Sandwich Price NT " + 250 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    /*if (pos == 6) {
                        ...
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + "Chicken Wings Price NT " + 170 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    /*if (pos == 7) {
                        ...
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Chicken Broast Price NT " + 550 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    if (pos == 3) {
                        ...
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Chicken Nuggets Price NT " + 200 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
